...
public class ChiTietBaiDang_Search extends AppCompatActivity {
    ImageView imgNha;
    ...
    private void MoFormGiaSH(){
        Intent i  = new Intent(ChiTietBaiDang_Search.this, GiaSH_Viewer.class);
        Bundle b = new Bundle();
    ...
    private void DownloadNCT(){
        Progress();
        arrNCT.clear();
        for(int i=0;i<arrnct_da_nhan.size();i++){
            if(arrnct_da_nhan.get(i).getIdNha().compareTo(nha.getId())==0){
                arrNCT.add(arrnct_da_nhan.get(i));
            }
        }
        LoadAnhNCTTuSQLITE();
        LoadAnhVaoImage();
    ...
    private void AnhXa() {
        ...
        LinearLayoutManager linearLayoutManager2 = new LinearLayoutManager(ChiTietBaiDang_Search.this, LinearLayoutManager.VERTICAL, false);
        reView_DSPhong.setLayoutManager(linearLayoutManager2);
        adapter_dsNhaCT = new Adapter_DSNhaCT(arrAnhNCT,arrNCT, getApplicationContext(),ChiTietBaiDang_Search.this);
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(ChiTietBaiDang_Search.this, LinearLayoutManager.VERTICAL, false);
        ...
        LinearLayoutManager linearLayoutManager3 = new LinearLayoutManager(ChiTietBaiDang_Search.this, LinearLayoutManager.VERTICAL, false);
    ...
    public void Progress(){
        progressBar = new ProgressDialog(ChiTietBaiDang_Search.this);
        progressBar.show();
